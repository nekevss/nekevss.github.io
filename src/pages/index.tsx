...
export default function Home() {
  return (
    <div className={`flex min-h-screen flex-col items-center justify-between p-24 ${inter.className}`}>
      <div className="flex flex-col w-1/2 max-w-5xl items-left justify-between font-mono text-sm lg:flex">
        <h1 className='text-4xl my-6'>Hi! My name's Kevin.</h1>
        <h3 className="text-2xl my-4">A little bit about me:</h3>
        <p className='my-4'>
          I like programming, games, and nature (hiking, camping, and whatever). As you might guess, two of those things sort of
          get in the way of the other. 🤣
        </p>
        <p className='my-4'>
          Anyways, this personal site/blog is going to remain pretty bare bones right now. For a couple reasons: (1) I like the ideas
          of a minimal and elegant aesthetic, and (2) I'm hoping to use this site more as a staging ground/entry point for
          some other projects or ideas.
        </p>
